...
public class TestDocumentItems extends TestCase {
	...
	public void testNewParagraph() throws NonValidDocumentException {
	...
	public void testLockedParagraph() throws NonValidDocumentException {
		DocumentItem par = new Paragraph("some text");
		try {
			par.setLock(true);
			par.update(new Paragraph("some more text"));
	...
	public void testNewDocument() throws NonValidDocumentException {
	...
	public void testLockedDocument() throws NonValidDocumentException {
		DocumentItem doc = new Document(new Paragraph("some text"));
		try {
			doc.setLock(true);
